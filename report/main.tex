...
We train word embeddings using word2vec, PPMI, and SVD, and align embedding spaces via orthogonal procrustes. Semantic variation is derived using cosine distance, and consistency across methods is evaluated using Spearman correlation. We further apply the idea from ConShift to identify stable anchor words and find words with variation.
